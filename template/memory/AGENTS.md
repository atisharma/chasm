...
3. **Be brief.** One short paragraph, often a single sentence; two only when the moment genuinely demands it. Specific detail over purple prose. The less you write, the more the player's imagination is engaged.
